...
const Home = () => (
    <Layout>
        <div className="home">
        <h1 className="home__title">Danco Web Service:  Transformando tus ideas en realidad digital</h1>
        ...
        <h2 className="home__subtitle">¿Quiénes somos?</h2>
        ...
        <section className="home__section">
            <h2 className="home__subtitle">Nuestros servicios</h2>
            <ul className="home__list">
            <li className="home__list-item"><strong>Desarrollo Web</strong>: Desde sitios web corporativos hasta blogs personales, creamos páginas web que no solo destacan por su diseño, sino también por su rendimiento y seguridad.</li>
            <li className="home__list-item"><strong>E-commerce</strong>: Diseñamos y desarrollamos plataformas de comercio electrónico que facilitan la experiencia de compra en línea, optimizando procesos y garantizando una interfaz amigable.</li>
            <li className="home__list-item"><strong>Páginas Web</strong>: Personalizamos cada proyecto para reflejar la esencia y objetivos de tu marca, asegurándonos de que tu presencia en línea sea tan única como tu negocio.</li>
            </ul>
        </section>

        <section className="home__section">
            <h2 className="home__subtitle">¿Por qué elegirnos?</h2>
        ...
        <p className="home__conclusion">En <strong>Danco Web Service</strong>, tu visión es nuestra misión. Déjanos ayudarte a transformar tus ideas en realidad digital y llevar tu negocio al éxito en el mundo en línea.</p>
    </div>
    </Layout>
);
export { Home }